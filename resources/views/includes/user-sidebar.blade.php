    ...
    <aside class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_dashboard') }}"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Trade Market</span></a>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_trade') }}"><i class="side-menu__icon fas fa-chart-line"></i><span class="side-menu__label">Trade</span></a>
                </li>
                <li class="slide">
